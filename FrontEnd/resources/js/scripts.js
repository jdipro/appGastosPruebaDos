...
//el domEL, trae el html y lo parsea (va detectando lo q hay adentro).
...
document.addEventListener("DOMContentLoaded", function (event) {
    drawCategory()
    //Obtiene las transacciones desde el localStorage (abajo entre //).
    //let transactionObjArr = JSON.parse(localStorage.getItem("transactionData"))//Esto se cambió.

    //Obtiene las transacciones desde el servidor. Tranforma y muestrar en pantalla.
...
function getTransactionFromBackEndAPI() {
    //Llama al backend, obtiene las transactions, guarda en un array.
